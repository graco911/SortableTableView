...
namespace App1
{
    public class Database
    {
        public Database()
        {
            var audi = new CarProducer(Resource.Drawable.navigation_empty_icon, "Audi");
            ...
            var bmw = new CarProducer(Resource.Drawable.navigation_empty_icon, "BMW");
            ...
            var porsche = new CarProducer(Resource.Drawable.navigation_empty_icon, "Porsche");
